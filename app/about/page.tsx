...
import Notepad from '@/app/v2/about/Notepad'
import Mirror from '@/app/v2/about/Mirror'
import VinylPlayer from '@/app/v2/about/VinylPlayer'
  ...
  return (
    <RoomFrame contentStyle={{ alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div className="ab-stage">
            ...
            {/* Vinyl player — decorative pixel-art (no overlay) */}
            <VinylPlayer />
      ...
      <style>{`
        ...
        @media (max-width: 760px) {
          ...
          /* Keep objects in flow but positioned so hover image is contained */
          .ab-obj {
          ...
          .ab-notepad { width: 220px !important; }
