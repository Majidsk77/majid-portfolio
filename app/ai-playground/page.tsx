...
const TOYS: Toy[] = [
  ...
  { id: 'coin',     label: 'Boundaries: an AI Playground experiment', src: '/images/playground/coin.png', href: '/ai-playground/boundaries', left: '43.6%', top: '40.5%', width: '12.8%', bubble: 'Track your boundaries in one place',                           bubbleDir: 'right' },
